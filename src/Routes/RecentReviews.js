...
class ReviewPage extends Component {
    ...
    //Filter reviews for specified star rating
    filterChange =() =>{
        let self = this;
        let updatedTimer = ()=>{
            self.setState({
        ...
        if(self.state.filterValue !== '') {
            ...
            //If value is default, search all reviews
            axios({
                method: 'get',
                url: '/select/ReviewTable',
            }).then(function (res) {
                ...
                <nav className="navbar navbar-inverse">
                    ...
                    <div className="navbar-collapse collapse" id="bs-example-navbar-collapse-2" aria-expanded="true">
                        ...
                        <ul className="nav navbar-nav">
                            ...
                            <li className="active"><NavLink exact to="/RecentReviews">Recent Reviews</NavLink></li>
                            ...
                            {this.state.noReviews &&(
                                <div className="row">
                                    ...
                                    <div className="col-md-10 alert alert-danger text-center">
                                        <strong>No reviews have been made yet!</strong>
                                    </div>
                                </div>
                            )}
